...
VALIDATE_ONLY=true \
bash src/scout_apps/control/spmpc_local_planner/scripts/run_spmpc_mocap_slosh_nowcast_shadow_trial.sh
```
...
bash src/scout_apps/control/spmpc_local_planner/scripts/run_spmpc_slosh_nowcast_replay.sh
```

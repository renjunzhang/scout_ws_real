#!/usr/bin/env python3
"""Static and negative tests for the v11 artificial-viscosity probe runner."""
...
import r8_liquid_u3_gpu_viscoart0p3_probe_runner_v1 as runner  # noqa: E402
...
class ViscoartProbeRunnerTests(unittest.TestCase):
    ...
    def test_exact_argv_has_one_official_viscosity_and_restart(self) -> None:
        ...
        self.assertEqual(argv.count("-partbegin:801:801"), 1)
    ...
    def test_rejects_viscosity_drift(self) -> None:
        self._reject(lambda value: value["solver"]["argv"].__setitem__(12, "-viscoart:0.4"))

    def test_rejects_restart_drift(self) -> None:
        self._reject(lambda value: value["restart"].__setitem__("part_index", 800))

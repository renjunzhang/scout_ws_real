#!/usr/bin/env python3
"""Static and negative tests for the 35.05--36.05 s extension runner."""
...
import r8_liquid_u3_gpu_viscoart0p2_settle_extension_runner_v1 as runner  # noqa: E402
...
class SettleExtensionRunnerTests(unittest.TestCase):
    def test_exact_single_gpu_command(self) -> None:
        ...
        self.assertEqual(argv.count("-tmax:36.05"), 1)
    ...
    def test_only_end_time_delta_is_frozen(self) -> None:
        ...
        self.assertEqual(runner.EXPECTED_DELTA["candidate"], "36.05")
    ...
    def test_output_and_resource_bounds_are_closed(self) -> None:
        self.assertEqual(runner.EXPECTED_OUTPUT["part_count"], 21)
        self.assertEqual(runner.EXPECTED_OUTPUT["part_first"], 701)
        self.assertEqual(runner.EXPECTED_OUTPUT["part_last"], 721)

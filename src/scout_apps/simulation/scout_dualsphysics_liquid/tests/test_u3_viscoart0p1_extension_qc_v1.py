#!/usr/bin/env python3
"""Static and negative tests for the v6 extension QC."""
...
import r8_liquid_u3_viscoart0p1_extension_qc_v1 as qc  # noqa: E402


class ExtensionQcTests(unittest.TestCase):
    ...
    def test_missing_or_nonfinite_metric_rejected(self) -> None:
        ...
        with self.assertRaises(qc.ExtensionQcError):

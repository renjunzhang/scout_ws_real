#!/usr/bin/env python3
"""Static and negative tests for the fresh v3_v8 identity adapter."""
...
class HandoffGateV10Tests(unittest.TestCase):
    ...
    def test_policy_delta_rejects_any_extra_or_identity_drift(self):
    ...
    def test_schema_delta_rejects_extra_or_wrong_parent(self):
    ...
    def test_self_check_is_static(self):
        ...
        self.assertEqual(report["status"], "PASS_S5A1_HANDOFF_GATE_V10_V3_V8_ADAPTER_STATIC_CONTRACT")

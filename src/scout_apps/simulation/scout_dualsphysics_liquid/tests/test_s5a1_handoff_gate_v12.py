#!/usr/bin/env python3
"""Static and negative tests for the fresh v3_v10 identity adapter."""
...
class HandoffGateV12Tests(unittest.TestCase):
    ...
    def test_self_check_is_static(self):
        ...
        self.assertEqual(
            report["status"],
            "PASS_S5A1_HANDOFF_GATE_V12_V3_V10_ADAPTER_STATIC_CONTRACT",
        )

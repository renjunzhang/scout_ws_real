"""Static/mock-only tests for the admitted one-shot U3 C1 GenCase v4 runtime."""
...
GATE_PATH = PACKAGE_DIR / "scripts/r8_liquid_target_u3_gencase_gate_v4.py"
HELPER_PATH = PACKAGE_DIR / "scripts/r8_liquid_u3_gencase_bootstrap_helper_v4.py"
SUPERVISOR_PATH = PACKAGE_DIR / "scripts/r8_liquid_target_u3_gencase_supervisor_v4.py"
POLICY_PATH = PACKAGE_DIR / "config/target_hosts/liquid_zrj_msi_u2404_u3_gencase_execution_policy_v4.json"
SCHEMA_PATH = PACKAGE_DIR / "schema/target_host_u3_gencase_execution_policy_v4.json"
PROFILE_PATH = PACKAGE_DIR / "config/apparmor_drafts/r8-liquid-u3-gencase-v4.profile"
...
class TargetU3GenCaseV4Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.gate = load_module("u3_gencase_gate_v4_test", GATE_PATH)
        cls.helper = load_module("u3_gencase_helper_v4_test", HELPER_PATH)
        cls.supervisor = load_module("u3_gencase_supervisor_v4_test", SUPERVISOR_PATH)
    ...
    def success_frame(self, *, bi4: bytes | None = None, xml: bytes | None = None, console: bytes = b"console") -> bytes:
        ...
        metadata = {
            "document_type": "SMPCC_R8_LIQUID_U3_C1_GENCASE_GUEST_FRAME_V4",
    ...
    def test_policy_schema_artifact_hashes_and_admitted_status(self):
        ...
        self.assertEqual(self.policy["status"], "ADMITTED_SINGLE_GENCASE_RUNTIME_V4_AFTER_FROZEN_V11_ZERO_DENIAL_PROBE")
    ...
    def test_v3_failure_is_frozen_and_seed_v2_receipt_is_pinned(self):
        ...
        self.assertEqual(rejected["execution_receipt_sha256"], "31facb61f218b9da03f7c5280b89f4a6d83ca37088427e864b3b360b43b40015")

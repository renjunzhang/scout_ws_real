"""Static/mock-only tests for the admitted one-shot U3 C1M GenCase v7 runtime."""
...
GATE_PATH = PACKAGE_DIR / "scripts/r8_liquid_target_u3_gencase_gate_v7.py"
HELPER_PATH = PACKAGE_DIR / "scripts/r8_liquid_u3_gencase_bootstrap_helper_v7.py"
SUPERVISOR_PATH = PACKAGE_DIR / "scripts/r8_liquid_target_u3_gencase_supervisor_v7.py"
POLICY_PATH = PACKAGE_DIR / "config/target_hosts/liquid_zrj_msi_u2404_u3_gencase_execution_policy_v7.json"
SCHEMA_PATH = PACKAGE_DIR / "schema/target_host_u3_gencase_execution_policy_v7.json"
PROFILE_PATH = PACKAGE_DIR / "config/apparmor_drafts/r8-liquid-u3-gencase-v7.profile"
...
class TargetU3GenCaseV7Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.gate = load_module("u3_gencase_gate_v7_test", GATE_PATH)
        cls.helper = load_module("u3_gencase_helper_v7_test", HELPER_PATH)
        cls.supervisor = load_module("u3_gencase_supervisor_v7_test", SUPERVISOR_PATH)
    ...
    def test_policy_schema_artifact_hashes_and_admitted_status(self):
        ...
        self.assertEqual(self.policy["status"], "ADMITTED_SINGLE_C1M_ZERO_MOTION_GENCASE_RUNTIME_V7_AFTER_FROZEN_V11_ZERO_DENIAL_PROBE")
    ...
    def test_frame_rejects_trailing_overdeclared_bad_bi4_xml_and_out(self):
        ...
        for invalid_motion_xml in (
            ...
            make_xml().replace(b'key="Shifting" value="1"', b'key="Shifting" value="2"'),
    ...
    def test_v5_failure_is_frozen_and_c1m_seed_v3_receipt_is_pinned(self):

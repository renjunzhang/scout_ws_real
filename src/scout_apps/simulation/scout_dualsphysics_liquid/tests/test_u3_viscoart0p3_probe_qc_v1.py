#!/usr/bin/env python3
"""Static and negative tests for the v11 viscosity-0.3 probe QC."""
...
import r8_liquid_u3_viscoart0p3_probe_qc_v1 as qc  # noqa: E402
...
class ViscoartProbeQcTests(unittest.TestCase):
    ...
    def test_single_delta_and_threshold_vector_are_exact(self) -> None:
        ...
        self.assertEqual(delta["baseline"]["const"], "0.2")
        self.assertEqual(delta["candidate"]["const"], "0.3")

#!/usr/bin/env python3
"""Static and negative tests for the v3_v5 identity adapter."""
...
import r8_liquid_s5a1_handoff_gate_v7 as gate  # noqa: E402


class HandoffGateV7Tests(unittest.TestCase):
    ...
    def test_policy_rejects_base_version_type_override_and_extra_drift(self) -> None:
    ...
    def test_schema_rejects_base_kind_override_and_extra_drift(self) -> None:

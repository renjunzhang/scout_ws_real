#!/usr/bin/env python3
"""Static gate and UID-1000 conduit for one U3 C1M cold-A settle v7.
...
HELPER_MAGIC = b"R8SOLVERHELPV7\0\0"
...
PROC_NUMERIC_PID_STAT_READ_RULE = "/proc/[0-9]*/stat r,"
OWNER_PROC_RULES = (
    "owner /proc/** r,",
...
NON_OWNER_PROC_RULES = (
    ...
    PROC_NUMERIC_PID_STAT_READ_RULE,
    "/proc/filesystems r,",
...
V6_FAILURE_PROVENANCE_CANONICAL_SHA256 = "ecb9ad774b8672004a58413c078f206d88ea3411e3e9d409b57f8d407b8d302c"
PROC_STAT_V1_V5_PROVENANCE_CANONICAL_SHA256 = "20d062e4ae76ee4579472dd443284246c1f90ce140947098b1cd156a36353f6a"
V6_CASE_ID = "u3_c1m_solver_cpu_settle_cold_a_v6_20260808T212044Z"
V6_CAMPAIGN_ID = "u3_c1m_solver_cpu_settle_ab_campaign_20260808T212044Z"
V6_SNAPSHOT_ROOT = Path(f"/run/r8-liquid-{V6_CASE_ID}.snapshot")
V6_WORKSPACE_FREEZE: dict[str, tuple[Path, str, int, str | None]] = {
    "policy": (
        PACKAGE_ROOT / "config/target_hosts/liquid_zrj_msi_u2404_u3_solver_cpu_settle_cold_a_execution_policy_v6.json",
        "0affbcabd5b587464b1a32c38ebd2abb139063c4f50000e0252801d199d59270",
        39_382,
        "REVIEWED_FRESH_C1M_CPU_SOLVER_SETTLE_COLD_A_V6_TWO_KNOWN_QUIET_DENY_RULES_PENDING_STATIC_VERIFICATION",
    ),
    "schema": (
        PACKAGE_ROOT / "schema/target_host_u3_solver_cpu_settle_cold_a_execution_policy_v6.json",
        "1d7dd5ead66196ba7e29c98070c64fd9817810cd2620e19b473e048f5f74f4b8",
        2_266,
        None,
    ),
    "profile": (
        PACKAGE_ROOT / "config/apparmor_drafts/r8-liquid-u3-solver-cpu-settle-cold-a-v6.profile",
        "a6841cd0fad78fa31e1a2a7b04eab0eb9158856884162112216ddcb8a01bfe0a",
        3_540,
        None,
    ),
    "gate": (
        PACKAGE_ROOT / "scripts/r8_liquid_target_u3_solver_cpu_settle_cold_a_gate_v6.py",
        "aa0510f17458a5d9cc2742c2f0b06170cb39b912cfe43e01926c9d6467435eb5",
        68_625,
        None,
    ),
    "helper": (
        PACKAGE_ROOT / "scripts/r8_liquid_u3_solver_cpu_settle_cold_a_bootstrap_helper_v6.py",
        "2e6290e27892cd00f9f75ee0f98e43ce8f0f44f0a5376a73cd5039b1080e1489",
        36_293,
        None,
    ),
    "supervisor": (
        PACKAGE_ROOT / "scripts/r8_liquid_target_u3_solver_cpu_settle_cold_a_supervisor_v6.py",
        "b1cf9cf1115cc44fa2b4d7e16da4ea5b33525d704ab4d0aa36bf6a96be8b401d",
        96_949,
        None,
    ),
    "test": (
        PACKAGE_ROOT / "tests/test_target_u3_solver_cpu_settle_cold_a_gate_v6.py",
        "8d5a6095f70d5dd93247f3257b8d44f34926442c374fa8541218a063965b78ca",
        73_993,
        None,
    ),
}
V6_FROZEN_RECEIPTS: dict[str, tuple[Path, str, int, str]] = {
    "start": (
        Path(f"/home/zrj/scout_liquid_lab/audits/{V6_CASE_ID}.start.json"),
        "07d1c2c3e212f8cd791531a59933695e7a078c7953808c842d28a19bd21f365f",
        11_634,
        "V6_COLD_A_ONE_SHOT_STARTED_NO_RETRY_SAME_IDENTITY",
    ),
    "execution": (
        Path(f"/home/zrj/scout_liquid_lab/audits/{V6_CASE_ID}.execution.json"),
        "7cba88d4793a58e05d2b7a0c6d843a8d6f0fec2e19541a9ff138a814ab1d4316",
        13_787,
        "V6_COLD_A_ATTEMPT_ABORTED_NO_RETRY_SAME_IDENTITY",
    ),
    "lifecycle_incomplete": (
        Path(f"/home/zrj/scout_liquid_lab/audits/{V6_CASE_ID}.lifecycle_incomplete.json"),
        "03958f6def1c609d21bd56120827d818085d5c3b96768a1da032f8b83c46b59f",
        6_239,
        "V6_COLD_A_LIFECYCLE_OR_EXECUTION_INCOMPLETE_NO_RETRY_SAME_IDENTITY",
    ),
}
V6_ABSENT_SUCCESS_PATHS = (
    Path(f"/home/zrj/scout_liquid_lab/audits/{V6_CASE_ID}.lifecycle.json"),
    Path(f"/home/zrj/scout_liquid_lab/audits/{V6_CASE_ID}.console.log"),
    Path(f"/home/zrj/scout_liquid_lab/cases/{V6_CASE_ID}.partial"),
)
PROC_V5_PROBE_ID = "u3_proc_stat_apparmor_boundary_probe_v5_20260809T042751Z"
PROC_V5_POLICY = PACKAGE_ROOT / "config/target_hosts/liquid_zrj_msi_u2404_u3_proc_stat_boundary_probe_policy_v5.json"
PROC_V5_POLICY_SHA256 = "8fc1cc9b1f065711da429894168495d7c78314a91d8e2268dd2ba50b816364cd"
PROC_V5_POLICY_SIZE = 55_999
PROC_V5_SNAPSHOT_ROOT = Path(f"/run/r8-liquid-{PROC_V5_PROBE_ID}.snapshot")
PROC_V5_FROZEN_RECEIPTS: dict[str, tuple[Path, str, int, str]] = {
    "start": (
        Path(f"/home/zrj/scout_liquid_lab/audits/{PROC_V5_PROBE_ID}.start.json"),
        "185ea7b3c6b845ed752b55afc439db87106ca3a9d79cbbb91931b5a0b0a210a5",
        6_874,
        "ONE_SHOT_STARTED_NO_RETRY_CLEANUP_REQUIRED",
    ),
    "execution": (
        Path(f"/home/zrj/scout_liquid_lab/audits/{PROC_V5_PROBE_ID}.execution.json"),
        "236501c7f36ce1c12ebf35b0bf7f1fa292660553f61c4c5a68bfe800a844f115",
        14_114,
        "ENUMERATED_HELPER_FAILURE_CLEANUP_PENDING",
    ),
    "lifecycle": (
        Path(f"/home/zrj/scout_liquid_lab/audits/{PROC_V5_PROBE_ID}.lifecycle.json"),
        "4cbdbfbb6a7d60eda8e4cf02c52b02887de6bd6601c50f65ba701aacd024f0b5",
        5_885,
        "PASS_U3_PROC_STAT_APPARMOR_BOUNDARY_PROBE_V5_LIFECYCLE_CLEANUP",
    ),
}
PROC_V5_ABSENT_RECEIPTS = tuple(
    Path(f"/home/zrj/scout_liquid_lab/audits/{PROC_V5_PROBE_ID}.{suffix}.json")
    for suffix in ("preflight_incomplete", "lifecycle_incomplete", "recovery")
)
...
def _verify_frozen_file(
    ...
    if len(raw) != size or hashlib.sha256(raw).hexdigest() != digest:
        raise GateError(f"frozen provenance bytes differ: {path.name}")
    if status is None:
        return raw, None
    try:
        document = json.loads(raw.decode("utf-8"))
    except (json.JSONDecodeError, UnicodeError) as exc:
        raise GateError(f"frozen provenance JSON is invalid: {path.name}") from exc
    if not isinstance(document, dict) or document.get("status") != status:
        raise GateError(f"frozen provenance status differs: {path.name}")
    return raw, document


def _verify_preserved_snapshot(
    root: Path,
    ...
    *,
    ...
    if (
        ...
        raise GateError(f"frozen snapshot root metadata differs: {root.name}")
    snapshot = start_document.get("snapshot", {})
    manifest = snapshot.get("files", {}) if isinstance(snapshot, dict) else {}
    if (
        not isinstance(manifest, dict)
        or len(manifest) != expected_count
        or sorted(os.listdir(root)) != sorted(manifest)
    ):
        raise GateError(f"frozen snapshot manifest differs: {root.name}")
    total_bytes = 0
    for name, entry in manifest.items():
        if (
            ...
            raise GateError(f"frozen snapshot entry is unsafe: {root.name}")
        path = root / name
        item = os.lstat(path)
        if (
            not stat.S_ISREG(item.st_mode)
            or (item.st_uid, item.st_gid) != (0, 0)
            or stat.S_IMODE(item.st_mode) != 0o444
            or item.st_nlink != 1
            or entry.get("path") != str(path)
            or entry.get("mode") != "0444"
            or entry.get("size_bytes") != item.st_size
        ):
            raise GateError(f"frozen snapshot artifact metadata differs: {name}")
        raw = read_regular_bytes(path, limit=80 * 1024 * 1024)
        if hashlib.sha256(raw).hexdigest() != entry.get("sha256"):
            raise GateError(f"frozen snapshot artifact bytes differ: {name}")
        total_bytes += len(raw)
    return {
        "root": str(root),
        "mode": "0555",
...
def verify_frozen_successor_provenance() -> dict[str, Any]:
    v6_workspace: dict[str, Any] = {}
    for name, (path, digest, size, status) in V6_WORKSPACE_FREEZE.items():
        _raw, document = _verify_frozen_file(path, digest, size, status)
        v6_workspace[name] = {
            "path": str(path),
            "sha256": digest,
            "size_bytes": size,
    ...
    v6_receipts: dict[str, dict[str, Any]] = {}
    v6_documents: dict[str, dict[str, Any]] = {}
    for name, (path, digest, size, status) in V6_FROZEN_RECEIPTS.items():
        _raw, document = _verify_frozen_file(path, digest, size, status)
        assert document is not None
        v6_documents[name] = document
        v6_receipts[name] = {
            "path": str(path),
            "sha256": digest,
            "size_bytes": size,
    ...
    v6_start = v6_documents["start"]
    v6_execution = v6_documents["execution"]
    v6_lifecycle = v6_documents["lifecycle_incomplete"]
    gate = v6_execution.get("gate", {})
    audit = v6_execution.get("audit", {})
    denials = audit.get("sanitized_denials", []) if isinstance(audit, dict) else []
    expected_denial_hashes = [
    ...
    if (
        v6_start.get("case_id") != V6_CASE_ID
        or v6_start.get("campaign_id") != V6_CAMPAIGN_ID
        or v6_start.get("policy_sha256") != V6_WORKSPACE_FREEZE["policy"][1]
        or v6_execution.get("case_id") != V6_CASE_ID
        or v6_execution.get("campaign_id") != V6_CAMPAIGN_ID
        or v6_execution.get("campaign_role") != "cold_a"
        or v6_execution.get("primary_error")
        != "SupervisorError: AppArmor journal window is not closed with zero unexpected logged denials"
        or v6_execution.get("cleanup_errors") != []
        or v6_execution.get("frame") is not None
        or v6_execution.get("export") is not None
        or v6_execution.get("export_verification") is not None
        ...
        or gate.get("stderr_size_bytes") != 167
        or gate.get("stderr_sha256")
        != "cbf08cc8c7161d5caf6d37f1a5b2b1d2ea44f9ff604f9f8547cbdf912afb8eed"
        ...
        or [entry.get("line_sha256") for entry in denials]
        != expected_denial_hashes
    ):
        raise GateError("frozen cold-A v6 execution evidence differs")
    for entry in denials:
        ...
        if (
            ...
            or fields.get("operation") != "open"
            or fields.get("class") != "file"
            or fields.get("name") != "/proc/3/stat"
            or fields.get("comm") != "python3.12"
            or fields.get("requested_mask") != "r"
            or fields.get("denied_mask") != "r"
            or fields.get("fsuid") != "1000"
            or fields.get("ouid") != "0"
        ):
            raise GateError("frozen cold-A v6 exact stat denial differs")
    profiles = v6_lifecycle.get("profiles_after_observation", {})
    sysctls = v6_lifecycle.get("sysctls_after_observation", {})
    sudo = v6_lifecycle.get("sudo_timestamp_observation", {})
    expected_counts = {
        "r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v6-20260808t212044z": 0,
        "r8-liquid-u3-c1m-solver-cpu-settle-cold-a-runtime-v6-20260808t212044z": 0,
    }
    if (
        v6_lifecycle.get("case_id") != V6_CASE_ID
        or v6_lifecycle.get("campaign_id") != V6_CAMPAIGN_ID
        or v6_lifecycle.get("cleanup_errors") != []
        or v6_lifecycle.get("next_allowed_stage")
        != "STOP_COLD_A_FAILED_NO_COLD_B_ADMISSION"
        or v6_lifecycle.get("execution_receipt", {}).get("sha256")
        != V6_FROZEN_RECEIPTS["execution"][1]
        or profiles.get("kernel_exact_counts") != expected_counts
        or any(value.get("value") not in ("1\n", "61362\n") for value in sysctls.values())
        or sudo.get("clear", {}).get("returncode") != 0
        or sudo.get("noninteractive_true_must_fail", {}).get("returncode") != 1
    ):
        raise GateError("frozen cold-A v6 cleanup evidence differs")
    if any(path.exists() for path in V6_ABSENT_SUCCESS_PATHS):
        raise GateError("frozen cold-A v6 success artifact unexpectedly exists")
    v6_snapshot = _verify_preserved_snapshot(
        V6_SNAPSHOT_ROOT, v6_start, expected_count=17
    )
    if v6_snapshot["regular_file_bytes"] != 39_906_748:
        raise GateError("frozen cold-A v6 snapshot byte total differs")

    _raw, proc_policy = _verify_frozen_file(
        PROC_V5_POLICY,
        PROC_V5_POLICY_SHA256,
        PROC_V5_POLICY_SIZE,
        "STATIC_READY_V5_PENDING_INDEPENDENT_REVIEW_AND_EXPLICIT_SINGLE_ATTEMPT",
    )
    assert proc_policy is not None
    expected_proc_keys = {
        "cold_a_v6_failure",
        "proc_stat_v1_static_no_go",
        "proc_stat_v2_prestart_no_go",
        "proc_stat_v3_runtime_no_go",
        "proc_stat_v4_runtime_no_go",
    }
    if (
        proc_policy.get("frozen_identity", {}).get("probe_id") != PROC_V5_PROBE_ID
        or set(proc_policy.get("provenance", {})) != expected_proc_keys
        or proc_policy.get("provenance", {}).get("cold_a_v6_failure", {})
        .get("stat_denials", {})
        .get("line_sha256")
        != expected_denial_hashes
    ):
        raise GateError("frozen proc-stat v1-v5 policy lineage differs")
    proc_documents: dict[str, dict[str, Any]] = {}
    proc_receipts: dict[str, dict[str, Any]] = {}
    for name, (path, digest, size, status) in PROC_V5_FROZEN_RECEIPTS.items():
        _raw, document = _verify_frozen_file(path, digest, size, status)
        assert document is not None
        proc_documents[name] = document
        proc_receipts[name] = {
            "path": str(path),
            "sha256": digest,
            "size_bytes": size,
    ...
    proc_start = proc_documents["start"]
    proc_execution = proc_documents["execution"]
    proc_lifecycle = proc_documents["lifecycle"]
    proc_gate = proc_execution.get("gate", {})
    proc_audit = proc_execution.get("apparmor_audit", {})
    if (
        proc_start.get("probe_id") != PROC_V5_PROBE_ID
        or proc_start.get("policy_sha256") != PROC_V5_POLICY_SHA256
        or proc_execution.get("probe_id") != PROC_V5_PROBE_ID
        or proc_execution.get("start_receipt", {}).get("sha256")
        != PROC_V5_FROZEN_RECEIPTS["start"][1]
        or proc_gate.get("returncode") != 2
        or proc_gate.get("stdout_size_bytes") != 0
        or proc_gate.get("stderr_size_bytes") != 243
        or proc_gate.get("stderr_sha256")
        != "e8756cc7d764f792118c7b3e09c33d78dd45871ba8fc3eef9269a168c9595263"
        or proc_gate.get("failure_frame")
        != {
            "boundary_status": "STATUS_READABLE",
            "failure_code": "STATUS_UNEXPECTEDLY_READABLE",
        }
        or proc_gate.get("root_cause_status") != "NOT_CLAIMED"
        or proc_gate.get("success_frame") is not None
        or proc_audit.get("capture_valid") is not True
        or proc_audit.get("capture_errors") != []
        or proc_audit.get("audit_loss_marker_status") != "NOT_OBSERVED"
        or proc_audit.get("matching_total") != 0
        or proc_audit.get("expected_status_total") != 0
        or proc_audit.get("stat_denial_total") != 0
        or proc_audit.get("unexpected_total") != 0
        or proc_execution.get("gencase_or_solver_executed") is not False
        or proc_execution.get("host_writable_mount_used") is not False
        or proc_execution.get("network_or_device_exposed") is not False
    ):
        raise GateError("frozen proc-stat v5 failure evidence differs")
    proc_counts = proc_lifecycle.get("profiles_after", {}).get(
        "kernel_exact_counts"
    )
    if (
        proc_lifecycle.get("probe_id") != PROC_V5_PROBE_ID
        or proc_lifecycle.get("execution_receipt", {}).get("sha256")
        != PROC_V5_FROZEN_RECEIPTS["execution"][1]
        or proc_lifecycle.get("next_allowed_stage")
        != "REVIEW_THIS_SINGLE_ATTEMPT_RECEIPT_AND_CREATE_FRESH_SUCCESSOR_ONLY"
        or proc_counts
        != {
            "r8-liquid-u3-proc-stat-boundary-bootstrap-v5-20260809t042751z": 0,
            "r8-liquid-u3-proc-stat-boundary-runtime-v5-20260809t042751z": 0,
        }
        or proc_lifecycle.get("sysctls", {}).get("unchanged") is not True
        or proc_lifecycle.get("sudo_timestamp", {})
        .get("noninteractive_true_must_fail", {})
        .get("returncode")
        != 1
    ):
        raise GateError("frozen proc-stat v5 cleanup evidence differs")
    if any(path.exists() for path in PROC_V5_ABSENT_RECEIPTS):
        raise GateError("frozen proc-stat v5 absent receipt unexpectedly exists")
    proc_snapshot = _verify_preserved_snapshot(
        PROC_V5_SNAPSHOT_ROOT, proc_start, expected_count=5
    )
    return {
        "cold_a_v6": {
            "workspace": v6_workspace,
            "receipts": v6_receipts,
            "snapshot": v6_snapshot,
            "identity_consumed": True,
            "retry_forbidden": True,
        },
        "proc_stat_v1_v5": {
            "policy": {
                "path": str(PROC_V5_POLICY),
                "sha256": PROC_V5_POLICY_SHA256,
                "size_bytes": PROC_V5_POLICY_SIZE,
            },
            "receipts": proc_receipts,
...
def guest_loader(*, helper_size: int, helper_sha256: str) -> str:
    return (
        ...
        "g={'__name__':'__main__','__file__':'<r8-liquid-u3-c1m-solver-cpu-settle-cold-a-helper-v7>'}\n"
...
def verify_profile() -> dict[str, Any]:
    ...
    if hashlib.sha256(_canonical_profile(text).encode("utf-8")).hexdigest() != PROFILE_CANONICAL_SHA256:
        raise GateError("solver AppArmor profile differs from the exact v7 canonical allowlist")
    ...
    if owner_proc_lines != list(OWNER_PROC_RULES):
        raise GateError("bootstrap owner /proc authority differs from the v6 baseline")
    if non_owner_proc_lines != list(NON_OWNER_PROC_RULES):
        raise GateError("bootstrap non-owner /proc authority exceeds the exact v7 allowlist")
    if any(
...
def verify_review_artifacts(*, verify_tools: bool = True) -> dict[str, Any]:
    ...
    if (
        canonical_json_sha256(provenance.get("consumed_cold_a_v6_attempt"))
        != V6_FAILURE_PROVENANCE_CANONICAL_SHA256
    ):
        raise GateError("consumed cold-A v6 failure provenance differs")
    if (
        canonical_json_sha256(provenance.get("proc_stat_boundary_probe_v1_v5"))
        != PROC_STAT_V1_V5_PROVENANCE_CANONICAL_SHA256
    ):
        raise GateError("proc-stat boundary v1-v5 provenance differs")
    frozen_provenance = verify_frozen_successor_provenance()
    ...
    if (
        ...
        raise GateError("cold-A v7 campaign or one-shot identity differs")
    ...
    if (
        input_frame.get("helper_magic") != "R8SOLVERHELPV7\\0\\0"
        or input_frame.get("input_magic") != "R8SOLVERINPUT7\\0\\0"
        or output_frame.get("magic") != "R8SOLVEROUTV7\\0\\0\\0"
        or output_frame.get("version") != 7
        ...
        or transport.get("abi_baseline") != "cold_a_v6_normalized"
        or transport.get("abi_delta_from_v6") != "version_discriminator_only"
    ):
        raise GateError("cold-A v7 immutable transport contract differs")
    ...
    if (
        ...
        or invariants.get("v6_identity_consumed_and_never_retried") is not True
        or invariants.get("v6_snapshot_and_runtime_outputs_are_provenance_only") is not True
        or invariants.get("proc_stat_v1_v5_identities_consumed_and_never_retried") is not True
        or invariants.get("proc_stat_v1_v5_snapshots_receipts_and_outputs_are_provenance_only") is not True
        or invariants.get("v7_profile_delta_is_exact_numeric_pid_stat_read_only") is not True
    ...
    if (
        ...
        or lifecycle.get("proc_numeric_pid_stat_read_rule")
        != PROC_NUMERIC_PID_STAT_READ_RULE
        or lifecycle.get("proc_authority_baseline") != "cold_a_v6_profile_normalized"
        or lifecycle.get("proc_authority_delta_from_v6")
        != "one_exact_non_owner_numeric_pid_stat_read_rule_only"
        or lifecycle.get("authority_basis")
        != "two_frozen_cold_a_v6_proc_3_stat_DENIED_records_fsuid_1000_ouid_0"
    ):
...
def main() -> int:
    ...
    try:
        if arguments.command == "self-check":
            ...
            print(json.dumps({"status": "PASS_SOLVER_CPU_SETTLE_COLD_A_V7_STATIC_EXECUTION_NOT_PERFORMED", "review": review}, ensure_ascii=False, sort_keys=True))
            return 0
        ...
        print(json.dumps({"status": "SOLVER_CPU_SETTLE_COLD_A_V7_NO_GO", "error": str(exc)}, ensure_ascii=False, sort_keys=True), file=stream)
        return 2

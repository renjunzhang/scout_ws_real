#!/usr/bin/env python3
"""S5A0 worker v7 pinned to padded-header reader v4."""
...
import r8_liquid_s5a0_selected_bag_worker_v6 as worker_v6
...
def self_check() -> dict[str, Any]:
    base = worker_v6.self_check()
    return {
        **base,
        "status": "PASS_S5A0_SELECTED_BAG_WORKER_V7_STATIC_CONTRACT",
        "reader_revision": "v4",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        reader_v4.BagV2Error, OSError, ValueError,
    ) as exc:
        print(json.dumps({

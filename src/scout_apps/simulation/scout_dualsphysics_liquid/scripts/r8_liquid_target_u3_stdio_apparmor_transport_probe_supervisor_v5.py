#!/usr/bin/env python3
"""Root lifecycle supervisor for the one-shot harmless v5 successor probe.
...
WORKSPACE_SUPERVISOR_PATH = Path("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v5.py")
PROBE_ID = "u3_stdio_apparmor_transport_probe_v5_20260807T170359Z"
SNAPSHOT_ROOT = Path(f"/run/r8-liquid-{PROBE_ID}.snapshot")
SNAPSHOT_ENV = "R8_LIQUID_U3_STDIO_PROBE_V5_SNAPSHOT"
ADMISSION_ENV = "R8_LIQUID_U3_STDIO_PROBE_V5_ADMISSION"
ADMISSION_FD_ENV = "R8_LIQUID_U3_STDIO_PROBE_V5_ADMISSION_FD"
ADMISSION_SHA256_ENV = "R8_LIQUID_U3_STDIO_PROBE_V5_ADMISSION_SHA256"
ADMISSION_TOKEN = f"{PROBE_ID}:single-harmless-attempt"
RECOVERY_TOKEN = f"{PROBE_ID}:cleanup-only-no-probe"
PREDECESSOR_NO_GO = {
    "probe_id": "u3_stdio_apparmor_transport_probe_v4_20260807T163041Z",
    "snapshot_root": "/run/r8-liquid-u3_stdio_apparmor_transport_probe_v4_20260807T163041Z.snapshot",
    "status": "PRE_START_PROFILE_STATE_JSON_OPTION_CONFLICT_NO_GO",
    "snapshot_created": True,
    "snapshot_directory_mode": "0555",
    "snapshot_files_mode": "0444",
    "direct_exec_would_eacces": True,
    "root_supervisor_preflight_entered": True,
    "failed_argv": ["/usr/sbin/aa-status", "--json", "--show", "profiles"],
    "failure_reason": "AA_STATUS_PRIMARY_OPTION_CONFLICT_RETURNED_HUMAN_NON_JSON_OUTPUT",
    ...
    "sudo_global_timestamp_cleanup_completed": True,
    "sudo_noninteractive_true_returncode": 1,
    "identity_consumed": True,
    "preserve_snapshot": True,
}
POLICY_NAME = "liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v5.json"
SCHEMA_NAME = "target_host_u3_stdio_apparmor_transport_probe_policy_v5.json"
PROFILE_NAME = "r8-liquid-u3-stdio-transport-probe-v5.profile"
GATE_NAME = "r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v5.py"
SUPERVISOR_NAME = SCRIPT_PATH.name
BOOTSTRAP_PROFILE = "r8-liquid-u3-stdio-transport-bootstrap-v5-20260807t170359z"
RUNTIME_PROFILE = "r8-liquid-u3-stdio-transport-runtime-v5-20260807t170359z"
LABELS = (BOOTSTRAP_PROFILE, RUNTIME_PROFILE)
HOST_UID = 1000
HOST_GID = 1000
SUCCESS_MAGIC = b"R8LQSTDIOPASSV5\x00"
MAX_SUCCESS_FRAME_BYTES = 16_384
TMPFS_BYTES = 67_108_864
EXPECTED_INPUTS = {
    "probe_alpha.bin": {"size_bytes": 264, "sha256": "53bd8a0b136c98b7ac7f35e64e89a714f66188530f9ef634f07f27346e8bc24c"},
    "probe_beta.bin": {"size_bytes": 519, "sha256": "1ffd71cdd841e50be4a4d6a3c95dfcef172921b62fa6218dec8da27bb946c903"},
    "probe_gamma.bin": {"size_bytes": 993, "sha256": "0f59fd5a18007e62fd39b087d0805ae750f1019772fa8a1d3258bf0b92696d94"},
}
...
ROOT="/run"
NAME="r8-liquid-u3_stdio_apparmor_transport_probe_v5_20260807T170359Z.snapshot"
SOURCES=(
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v5.py","r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v5.py"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v5.py","r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v5.py"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/apparmor_drafts/r8-liquid-u3-stdio-transport-probe-v5.profile","r8-liquid-u3-stdio-transport-probe-v5.profile"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/schema/target_host_u3_stdio_apparmor_transport_probe_policy_v5.json","target_host_u3_stdio_apparmor_transport_probe_policy_v5.json"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/target_hosts/liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v5.json","liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v5.json"),
)
def open_abs(path):
...
os.write(1,(json.dumps({"status":"ROOT_SNAPSHOT_V5_CREATED_NOT_EXECUTED","files":manifest},sort_keys=True,separators=(",",":"))+"\n").encode("ascii"))
'''
...
g={{"__name__":"__main__"}}
exec(compile(p,"<r8-liquid-root-snapshot-bootstrap-v5>","exec",dont_inherit=True,optimize=2),g,g)
'''
...
def repository_static_review() -> dict[str, Any]:
    ...
    if policy.get("status") != "STATIC_READY_V5_PENDING_INDEPENDENT_REVIEW_AND_EXPLICIT_SINGLE_ATTEMPT":
        raise SupervisorError("v5 static status differs")
    ...
    if transport.get("success_magic_hex") != SUCCESS_MAGIC.hex():
        raise SupervisorError("fresh v5 success protocol magic differs")
    expected_frozen = {
        "probe_id": PROBE_ID,
    ...
    if policy.get("provenance", {}).get("predecessor_no_go") != PREDECESSOR_NO_GO:
        raise SupervisorError("predecessor command-mode NO_GO record differs")
...
def verify_snapshot_producer_identity() -> dict[str, Any]:
    ...
    if SCRIPT_PATH != WORKSPACE_SUPERVISOR_PATH:
        raise SupervisorError("snapshot producer must be the exact workspace v5 supervisor")
...
def parse_success_frame(frame: bytes) -> dict[str, Any]:
    ...
    if (value["status"] != "PASS_HARMLESS_STDIO_APPARMOR_TRANSPORT_PROBE_V5"
...
def classify_execution(result: Mapping[str, Any], audit: Mapping[str, Any]) -> tuple[str, dict[str, Any]]:
    ...
    gate_no_go_envelope = (
        ...
        or b"R8_STDIO_PROBE_V5_NO_GO" in stderr
    )
...
def execution_receipt_document(
    *,
    ...
    return {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V5_EXECUTION_RECEIPT",
        "probe_id": PROBE_ID,
        "status": status,
...
def lifecycle_document(
    *,
    ...
    return {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V5_LIFECYCLE_RECEIPT",
        "probe_id": PROBE_ID,
        "status": "PASS_V5_PROFILE_PROCESS_SYSCTL_SUDO_LIFECYCLE_CLEANUP",
...
def run_once(*, policy_sha256: str, admission_token: str) -> dict[str, Any]:
    with TerminationGuard() as termination_guard:
        try:
            ...
            document = {
                "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V5_PREFLIGHT_FAILURE_RECEIPT",
                "probe_id": PROBE_ID,
...
def _run_once_guarded(
    *,
    ...
    start_document = {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V5_START_RECEIPT",
        "probe_id": PROBE_ID,
    ...
    failure = {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V5_LIFECYCLE_INCOMPLETE_RECEIPT",
        "probe_id": PROBE_ID,
    ...
    raise SupervisorError(f"v5 lifecycle incomplete; preserved receipt {failure_record['path']}")
...
def recover_only(*, policy_sha256: str, recovery_token: str) -> dict[str, Any]:
    ...
    with TerminationGuard() as termination_guard:
        ...
        document = {
            "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V5_RECOVERY_RECEIPT",
            "probe_id": PROBE_ID,
            "status": "PASS_V5_CLEANUP_ONLY_NO_PROBE_EXECUTED",
            "policy_sha256": policy_sha256,
            "snapshot": snapshot,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if arguments.command == "recover-only":
            ...
            print(json.dumps({"status": "V5_CLEANUP_ONLY_RECORDED", "result": result}, ensure_ascii=False, sort_keys=True))
            return 0
        result = run_once(policy_sha256=arguments.policy_sha256, admission_token=arguments.admission_token)
        print(json.dumps({"status": "V5_ONE_SHOT_LIFECYCLE_RECORDED", "result": result}, ensure_ascii=False, sort_keys=True))

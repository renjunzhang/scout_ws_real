#!/usr/bin/env python3
"""Fresh GPU artificial-viscosity 0.2 cold-A/B runner.
...
``CFL=0.1``, ``Shifting=None``, ``DDT2(0.1)`` and artificial viscosity 0.2.
...
SCHEMA_PATH = PACKAGE_ROOT / "schema/target_host_u3_viscoart0p2_cold_ab_policy_v1.json"
TEST_PATH = PACKAGE_ROOT / "tests/test_u3_gpu_viscoart0p2_cold_ab_runner_v1.py"
QC_PATH = SCRIPT_PATH.parent / "r8_liquid_u3_viscoart0p2_cold_ab_qc_v1.py"
QC_SCHEMA_PATH = PACKAGE_ROOT / "schema/target_host_u3_viscoart0p2_cold_ab_qc_v1.json"
QC_TEST_PATH = PACKAGE_ROOT / "tests/test_u3_viscoart0p2_cold_ab_qc_v1.py"
POLICY_PATHS = {
    "a": PACKAGE_ROOT / "config/target_hosts/liquid_zrj_msi_u2404_u3_stage4_viscoart0p2_cold_a_20260811T080852Z_v8.json",
    "b": PACKAGE_ROOT / "config/target_hosts/liquid_zrj_msi_u2404_u3_stage4_viscoart0p2_cold_b_20260811T080852Z_v8.json",
}
RUN_IDS = {
    "a": "u3_c1m_gpu_viscoart0p2_cold_a_20260811T080852Z_v8",
    "b": "u3_c1m_gpu_viscoart0p2_cold_b_20260811T080852Z_v8",
}
PURPOSES = {"a": "viscoart0p2_fresh_cold_a", "b": "viscoart0p2_fresh_cold_b"}
PRIOR_QC_PATH = Path("/home/zrj/scout_liquid_lab/audits/u3_c1m_gpu_viscoart0p2_probe_from_0601_20260811T074334Z_v7.qc_v1.json")
PRIOR_QC_SHA256 = "fd77bf902d30199239ec626c65eb6a4b83a1f2dfcfecfe3813cd879a778e4c3d"
PRIOR_FINAL_PATH = Path("/home/zrj/scout_liquid_lab/audits/u3_c1m_gpu_viscoart0p2_probe_from_0601_20260811T074334Z_v7.final.json")
PRIOR_FINAL_SHA256 = "46d802d77a97aa09f996069bebff21f325f486fdc1a1bc49ce40dcc2c9067a1e"
...
EXPECTED_DELTA = {
    ...
    "baseline": "V7_RESTARTED_SENSITIVITY_PROBE",
...
def semantic_validate(policy: dict[str, Any], policy_path: Path) -> None:
    ...
    if policy["parents"]["prior_qc"]["sha256"] != PRIOR_QC_SHA256:
        raise ColdAbRunError("v7 QC identity differs")
    if policy["parents"]["prior_tail_final"]["sha256"] != PRIOR_FINAL_SHA256:
        raise ColdAbRunError("v7 final receipt identity differs")
...
def self_check(policy_path: Path) -> dict[str, Any]:
    ...
    return {
        "status": "PASS_U3_VISCOART0P2_COLD_AB_RUNNER_V1_SELF_CHECK",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.command == "self-check":
            ...
            result = {"status": "PASS_U3_VISCOART0P2_COLD_AB_PREFLIGHT", "evidence": base.preflight(args.policy, require_fresh=True)}
        else:
        ...
        print(json.dumps({"status": "FAIL_U3_VISCOART0P2_COLD_AB_RUNNER", "error_type": type(exc).__name__, "error": str(exc)}, ensure_ascii=False, sort_keys=True), file=sys.stderr)
        return 1

#!/usr/bin/env python3
"""Root lifecycle supervisor for the one-shot harmless v6 successor probe.
...
WORKSPACE_SUPERVISOR_PATH = Path("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v6.py")
PROBE_ID = "u3_stdio_apparmor_transport_probe_v6_20260807T173214Z"
SNAPSHOT_ROOT = Path(f"/run/r8-liquid-{PROBE_ID}.snapshot")
SNAPSHOT_ENV = "R8_LIQUID_U3_STDIO_PROBE_V6_SNAPSHOT"
ADMISSION_ENV = "R8_LIQUID_U3_STDIO_PROBE_V6_ADMISSION"
ADMISSION_FD_ENV = "R8_LIQUID_U3_STDIO_PROBE_V6_ADMISSION_FD"
ADMISSION_SHA256_ENV = "R8_LIQUID_U3_STDIO_PROBE_V6_ADMISSION_SHA256"
ADMISSION_TOKEN = f"{PROBE_ID}:single-harmless-attempt"
RECOVERY_TOKEN = f"{PROBE_ID}:cleanup-only-no-probe"
PREDECESSOR_NO_GO = {
    "probe_id": "u3_stdio_apparmor_transport_probe_v5_20260807T170359Z",
    "snapshot_root": "/run/r8-liquid-u3_stdio_apparmor_transport_probe_v5_20260807T170359Z.snapshot",
    "status": "STATIC_METADATA_INCONSISTENCY_NO_GO",
    "snapshot_created": False,
    "start_receipt_created": False,
    "preflight_failure_receipt_created": False,
    "execution_receipt_created": False,
    "lifecycle_receipt_created": False,
    "lifecycle_failure_receipt_created": False,
    "recovery_receipt_created": False,
    "root_supervisor_preflight_entered": False,
    "sudo_invoked": False,
    "profile_loaded": False,
    "probe_executed": False,
    "sysctls_unchanged": True,
    "metadata_field": "profile_semantics.effective_lines_sha256",
    "recorded_sha256": "24294511ed489c0ac821a83c54232ad9397927fcb38466f89397ff557162ae4f",
    "actual_sha256": "857830b54949728f3ce4c5892b01d82d933c65895cc92c7770872a5903af8079",
    "corroborating_policy_field": "mount_discovery.effective_profile_lines_sha256",
    "corroborating_sha256": "857830b54949728f3ce4c5892b01d82d933c65895cc92c7770872a5903af8079",
    "identity_consumed": True,
    "preserve_snapshot": False,
    "workspace_files_preserved": True,
}
POLICY_NAME = "liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v6.json"
SCHEMA_NAME = "target_host_u3_stdio_apparmor_transport_probe_policy_v6.json"
PROFILE_NAME = "r8-liquid-u3-stdio-transport-probe-v6.profile"
GATE_NAME = "r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v6.py"
SUPERVISOR_NAME = SCRIPT_PATH.name
BOOTSTRAP_PROFILE = "r8-liquid-u3-stdio-transport-bootstrap-v6-20260807t173214z"
RUNTIME_PROFILE = "r8-liquid-u3-stdio-transport-runtime-v6-20260807t173214z"
LABELS = (BOOTSTRAP_PROFILE, RUNTIME_PROFILE)
HOST_UID = 1000
HOST_GID = 1000
SUCCESS_MAGIC = b"R8LQSTDIOPASSV6\x00"
MAX_SUCCESS_FRAME_BYTES = 16_384
TMPFS_BYTES = 67_108_864
EXPECTED_INPUTS = {
    "probe_alpha.bin": {"size_bytes": 264, "sha256": "6d0971c8813914f8a9f360bd80598fe9ad9afb20e846669bed9f219c5ad37929"},
    "probe_beta.bin": {"size_bytes": 519, "sha256": "7e4262529bdfe9d0ed079036c9422f8030aa61f519c35d85957cd1e2792815ee"},
    "probe_gamma.bin": {"size_bytes": 993, "sha256": "c05e5e0d71feedd532698f520dfe4bf8266c2bc9856d822ae04ec7d4148395fb"},
}
...
ROOT="/run"
NAME="r8-liquid-u3_stdio_apparmor_transport_probe_v6_20260807T173214Z.snapshot"
SOURCES=(
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v6.py","r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v6.py"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v6.py","r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v6.py"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/apparmor_drafts/r8-liquid-u3-stdio-transport-probe-v6.profile","r8-liquid-u3-stdio-transport-probe-v6.profile"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/schema/target_host_u3_stdio_apparmor_transport_probe_policy_v6.json","target_host_u3_stdio_apparmor_transport_probe_policy_v6.json"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/target_hosts/liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v6.json","liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v6.json"),
)
def open_abs(path):
...
os.write(1,(json.dumps({"status":"ROOT_SNAPSHOT_V6_CREATED_NOT_EXECUTED","files":manifest},sort_keys=True,separators=(",",":"))+"\n").encode("ascii"))
'''
...
g={{"__name__":"__main__"}}
exec(compile(p,"<r8-liquid-root-snapshot-bootstrap-v6>","exec",dont_inherit=True,optimize=2),g,g)
'''
...
def repository_static_review() -> dict[str, Any]:
    ...
    if policy.get("status") != "STATIC_READY_V6_PENDING_INDEPENDENT_REVIEW_AND_EXPLICIT_SINGLE_ATTEMPT":
        raise SupervisorError("v6 static status differs")
    ...
    if transport.get("success_magic_hex") != SUCCESS_MAGIC.hex():
        raise SupervisorError("fresh v6 success protocol magic differs")
    expected_frozen = {
        "probe_id": PROBE_ID,
    ...
    if policy.get("provenance", {}).get("predecessor_no_go") != PREDECESSOR_NO_GO:
        raise SupervisorError("predecessor static-metadata NO_GO record differs")
...
def verify_snapshot_producer_identity() -> dict[str, Any]:
    ...
    if SCRIPT_PATH != WORKSPACE_SUPERVISOR_PATH:
        raise SupervisorError("snapshot producer must be the exact workspace v6 supervisor")
...
def labeled_processes(proc_root: Path = Path("/proc")) -> list[dict[str, Any]]:
    """Authoritatively enumerate every task/thread carrying a fresh v6 label."""
...
def parse_success_frame(frame: bytes) -> dict[str, Any]:
    ...
    if (value["status"] != "PASS_HARMLESS_STDIO_APPARMOR_TRANSPORT_PROBE_V6"
...
def classify_execution(result: Mapping[str, Any], audit: Mapping[str, Any]) -> tuple[str, dict[str, Any]]:
    ...
    gate_no_go_envelope = (
        ...
        or b"R8_STDIO_PROBE_V6_NO_GO" in stderr
    )
...
def execution_receipt_document(
    *,
    ...
    return {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V6_EXECUTION_RECEIPT",
        "probe_id": PROBE_ID,
        "status": status,
...
def lifecycle_document(
    *,
    ...
    if type(sudo_clear) is not dict or set(sudo_clear) != {"scope", "pty", "clear", "noninteractive_true_must_fail"}:
    ...
    return {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V6_LIFECYCLE_RECEIPT",
        "probe_id": PROBE_ID,
        "status": "PASS_V6_PROFILE_PROCESS_SYSCTL_SUDO_LIFECYCLE_CLEANUP",
    ...
    with TerminationGuard() as termination_guard:
        try:
            ...
            try:
                ...
                cleanup_error = f"{type(cleanup_exc).__name__}: {cleanup_exc}"[:4096]
                raise SupervisorError(
                    "pre-start failure and sudo timestamp cleanup incomplete; "
                    f"primary={primary_error}; cleanup={cleanup_error}"
                ) from exc
            document = {
                "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V6_PREFLIGHT_FAILURE_RECEIPT",
                "probe_id": PROBE_ID,
                "status": "PRE_START_FAILURE_SUDO_TIMESTAMP_CLEANED_NO_PROFILE_LOAD_OR_PROBE_IDENTITY_CONSUMED",
            ...
            try:
                ...
                raise SupervisorError(
                    "pre-start failure; sudo timestamp cleaned but failure receipt incomplete; "
                    f"primary={primary_error}; receipt={receipt_error}"
                ) from exc
            raise SupervisorError(
                f"pre-start failure; sudo timestamp cleaned; preserved receipt {record['path']}"
            ) from exc
...
def _run_once_guarded(
    *,
    ...
    start_document = {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V6_START_RECEIPT",
        "probe_id": PROBE_ID,
    ...
    failure = {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V6_LIFECYCLE_INCOMPLETE_RECEIPT",
        "probe_id": PROBE_ID,
    ...
    raise SupervisorError(f"v6 lifecycle incomplete; preserved receipt {failure_record['path']}")
...
def recover_only(*, policy_sha256: str, recovery_token: str) -> dict[str, Any]:
    ...
    with TerminationGuard() as termination_guard:
        ...
        document = {
            "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V6_RECOVERY_RECEIPT",
            "probe_id": PROBE_ID,
            "status": "PASS_V6_CLEANUP_ONLY_NO_PROBE_EXECUTED",
            "policy_sha256": policy_sha256,
            "snapshot": snapshot,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if arguments.command == "recover-only":
            ...
            print(json.dumps({"status": "V6_CLEANUP_ONLY_RECORDED", "result": result}, ensure_ascii=False, sort_keys=True))
            return 0
        result = run_once(policy_sha256=arguments.policy_sha256, admission_token=arguments.admission_token)
        print(json.dumps({"status": "V6_ONE_SHOT_LIFECYCLE_RECORDED", "result": result}, ensure_ascii=False, sort_keys=True))

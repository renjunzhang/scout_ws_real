#!/usr/bin/env python3
"""Root lifecycle supervisor for the one-shot harmless v7 successor probe.
...
WORKSPACE_SUPERVISOR_PATH = Path("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v7.py")
PROBE_ID = "u3_stdio_apparmor_transport_probe_v7_20260807T175042Z"
SNAPSHOT_ROOT = Path(f"/run/r8-liquid-{PROBE_ID}.snapshot")
SNAPSHOT_ENV = "R8_LIQUID_U3_STDIO_PROBE_V7_SNAPSHOT"
ADMISSION_ENV = "R8_LIQUID_U3_STDIO_PROBE_V7_ADMISSION"
ADMISSION_FD_ENV = "R8_LIQUID_U3_STDIO_PROBE_V7_ADMISSION_FD"
ADMISSION_SHA256_ENV = "R8_LIQUID_U3_STDIO_PROBE_V7_ADMISSION_SHA256"
ADMISSION_TOKEN = f"{PROBE_ID}:single-harmless-attempt"
RECOVERY_TOKEN = f"{PROBE_ID}:cleanup-only-no-probe"
PREDECESSOR_NO_GO = {
    "probe_id": "u3_stdio_apparmor_transport_probe_v6_20260807T173214Z",
    "snapshot_root": "/run/r8-liquid-u3_stdio_apparmor_transport_probe_v6_20260807T173214Z.snapshot",
    "status": "ONE_SHOT_UNCLASSIFIED_GATE_IDENTITY_CONTRACT_NO_GO",
    ...
    "frozen_workspace_artifacts": {
        "gate": {"path": "/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v6.py", "sha256": "711da838735d49c09762e410db667d99d78392af6f010ae4936498b99e4e2be9", "size_bytes": 61770},
        "supervisor": {"path": "/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v6.py", "sha256": "56a6c615cdee1db6ee9d1a548f2b43cbd36870fee593ac8c39748f29948845e7", "size_bytes": 91220},
        "profile": {"path": "/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/apparmor_drafts/r8-liquid-u3-stdio-transport-probe-v6.profile", "sha256": "7e0beab340f276d42eb3cbd80f291520b3c397cd1dcceeb39817bf3cfbeb0d47", "size_bytes": 3630},
        "schema": {"path": "/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/schema/target_host_u3_stdio_apparmor_transport_probe_policy_v6.json", "sha256": "ce5bcf1e5f1ccdeb2b0807dbe14998856fff292afe9b6da7b8799e0092b4aacd", "size_bytes": 27035},
        "policy": {"path": "/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/target_hosts/liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v6.json", "sha256": "4fd942eb40f84f3ac1442f10aa35bb2d7341144320aba00084d78c0e2e027b2d", "size_bytes": 19667},
        "tests": {"path": "/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/tests/test_target_u3_stdio_apparmor_transport_probe_gate_v6.py", "sha256": "0fc821ea213ffe4dbd534240e69a13ac288aebf15defa9d7323690807cbda779", "size_bytes": 65380},
    },
    "receipts": {
        "start": {"path": "/home/zrj/scout_liquid_lab/audits/u3_stdio_apparmor_transport_probe_v6_20260807T173214Z.start.json", "sha256": "53c9415eff409b07505d0873b4dd964147b3d71141cb15e907a125316ea27d78", "size_bytes": 3689, "status": "ONE_SHOT_STARTED_CLEANUP_REQUIRED"},
        "execution": {"path": "/home/zrj/scout_liquid_lab/audits/u3_stdio_apparmor_transport_probe_v6_20260807T173214Z.execution.json", "sha256": "89005917d682f3cb637ee1427c0227ce694ad6b754550026f4c55eb3a04740d6", "size_bytes": 8937, "status": "UNCLASSIFIED_PROBE_FAILURE_CLEANUP_PENDING"},
        "lifecycle_incomplete": {"path": "/home/zrj/scout_liquid_lab/audits/u3_stdio_apparmor_transport_probe_v6_20260807T173214Z.lifecycle_incomplete.json", "sha256": "c2658fedf5590c621a19390c75e493a037d7cf26a8cb5e8e78bb7c4051fe7bb5", "size_bytes": 3254, "status": "LIFECYCLE_INCOMPLETE_NO_RETRY_SAME_IDENTITY"},
    },
    "profiles": {"loaded": True, "unloaded": True},
    "gate": {
        "internal_run_entered": True,
        "returncode": 2,
        "stdout_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        "stdout_size_bytes": 0,
        "stderr_sha256": "0c3cfc00767de47ddf495ddf2282115ba0e2f6bd9670cf9fb477a82316a42f13",
        "stderr_size_bytes": 99,
        "stderr_utf8_prefix": "{\"error\": \"unprivileged workspace snapshot producer identity contract differs\", \"status\": \"NO_GO\"}\n",
    },
    "bwrap_executed": False,
    "probe_payload_executed": False,
    "apparmor_matching_denials": 0,
    "sysctls_unchanged": True,
    "lifecycle_cleanup_error": "sudo_timestamp: SupervisorError: UID1000 sudo -K all-timestamp invalidation failed",
    "sudo_timestamp_cleanup_proven": False,
    "sudo_timestamp_observation_empty": True,
    "external_sudo_timestamp_cleanup_claimed": False,
    "production_authorized": False,
    "identity_consumed": True,
    "workspace_files_preserved": True,
}
POLICY_NAME = "liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v7.json"
SCHEMA_NAME = "target_host_u3_stdio_apparmor_transport_probe_policy_v7.json"
PROFILE_NAME = "r8-liquid-u3-stdio-transport-probe-v7.profile"
GATE_NAME = "r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v7.py"
SUPERVISOR_NAME = SCRIPT_PATH.name
BOOTSTRAP_PROFILE = "r8-liquid-u3-stdio-transport-bootstrap-v7-20260807t175042z"
RUNTIME_PROFILE = "r8-liquid-u3-stdio-transport-runtime-v7-20260807t175042z"
...
SUCCESS_MAGIC = b"R8LQSTDIOPASSV7\x00"
MAX_SUCCESS_FRAME_BYTES = 16_384
TMPFS_BYTES = 67_108_864
EXPECTED_INPUTS = {
    "probe_alpha.bin": {"size_bytes": 264, "sha256": "341941ae7df9840d6dd6888d3f8acb1eb324b0ab8879ab26a0dae72235515383"},
    "probe_beta.bin": {"size_bytes": 519, "sha256": "f91ade6253fa8109e1ad006fe372cadc13f102e9001d752e67b8288a95e954d0"},
    "probe_gamma.bin": {"size_bytes": 993, "sha256": "023fa8c4b32a2cd5477a6b33f3e31c91092a3669c49bd8281064b7a4d84660fc"},
}
...
ROOT="/run"
NAME="r8-liquid-u3_stdio_apparmor_transport_probe_v7_20260807T175042Z.snapshot"
SOURCES=(
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v7.py","r8_liquid_target_u3_stdio_apparmor_transport_probe_gate_v7.py"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/scripts/r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v7.py","r8_liquid_target_u3_stdio_apparmor_transport_probe_supervisor_v7.py"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/apparmor_drafts/r8-liquid-u3-stdio-transport-probe-v7.profile","r8-liquid-u3-stdio-transport-probe-v7.profile"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/schema/target_host_u3_stdio_apparmor_transport_probe_policy_v7.json","target_host_u3_stdio_apparmor_transport_probe_policy_v7.json"),
 ("/home/zrj/scout_ws/src/scout_apps/simulation/scout_dualsphysics_liquid/config/target_hosts/liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v7.json","liquid_zrj_msi_u2404_u3_stdio_apparmor_transport_probe_policy_v7.json"),
)
def open_abs(path):
...
os.write(1,(json.dumps({"status":"ROOT_SNAPSHOT_V7_CREATED_NOT_EXECUTED","files":manifest},sort_keys=True,separators=(",",":"))+"\n").encode("ascii"))
'''
...
g={{"__name__":"__main__"}}
exec(compile(p,"<r8-liquid-root-snapshot-bootstrap-v7>","exec",dont_inherit=True,optimize=2),g,g)
'''
...
def repository_static_review() -> dict[str, Any]:
    ...
    if policy.get("status") != "STATIC_READY_V7_PENDING_INDEPENDENT_REVIEW_AND_EXPLICIT_SINGLE_ATTEMPT":
        raise SupervisorError("v7 static status differs")
    ...
    if transport.get("success_magic_hex") != SUCCESS_MAGIC.hex():
        raise SupervisorError("fresh v7 success protocol magic differs")
    expected_frozen = {
        "probe_id": PROBE_ID,
    ...
    if policy.get("provenance", {}).get("predecessor_no_go") != PREDECESSOR_NO_GO:
        raise SupervisorError("predecessor v6 one-shot NO_GO record differs")
    ...
    mount_digest = policy.get("mount_discovery", {}).get("effective_profile_lines_sha256")
    ...
    return {"policy_sha256": sha256_bytes(policy_raw), "policy_size_bytes": len(policy_raw), "artifacts": observed, "bootstrap_source_sha256": SNAPSHOT_BOOTSTRAP_SHA256, "execution_performed": False}
...
def verify_snapshot_producer_identity() -> dict[str, Any]:
    ...
    if SCRIPT_PATH != WORKSPACE_SUPERVISOR_PATH:
        raise SupervisorError("snapshot producer must be the exact workspace v7 supervisor")
...
def labeled_processes(proc_root: Path = Path("/proc")) -> list[dict[str, Any]]:
    """Authoritatively enumerate every task/thread carrying a fresh v7 label."""
...
def parse_success_frame(frame: bytes) -> dict[str, Any]:
    ...
    if (value["status"] != "PASS_HARMLESS_STDIO_APPARMOR_TRANSPORT_PROBE_V7"
...
def capture_apparmor_denials(start_epoch: float, end_epoch: float) -> dict[str, Any]:
    argv = [
        "/usr/bin/journalctl", "-k", "--no-pager", "--output=short-iso-precise",
        f"--since=@{max(0.0, start_epoch - 1):.3f}", f"--until=@{end_epoch + 1:.3f}",
    ]
    result = run_bounded_command(argv, stdout_limit=131_072, stderr_limit=16_384, timeout_seconds=15)
    if result["returncode"] != 0 or result["failure"] is not None or result["stderr"]:
        raise SupervisorError("bounded kernel journal query failed")
    forbidden = ("/home/zrj/scout_ws", "GenCase", "DualSPHysics", "/dev/nvidia", "/opt/ros")
    sanitized: list[str] = []
    expected_proc_mkdir: list[str] = []
    unexpected: list[str] = []
    matching_total = 0
    expected_total = 0
    unexpected_total = 0
    try:
        ...
        raise SupervisorError("kernel journal output is not strict UTF-8") from exc
    for line in lines:
        if 'apparmor="DENIED"' not in line or not any(label in line for label in LABELS):
            continue
        matching_total += 1
        if any(token in line for token in forbidden):
            raise SupervisorError("audit line crossed a forbidden boundary")
        sanitized_line = re.sub(r"\b(pid|ppid|task|peer)=\d+", r"\1=<redacted>", line)[:4096]
        if len(sanitized) >= 16:
            pass
        else:
            sanitized.append(sanitized_line)
        is_expected = (
            f'profile="{BOOTSTRAP_PROFILE}"' in line
            and f'profile="{RUNTIME_PROFILE}"' not in line
            and 'operation="mkdir"' in line
            and 'name="/newroot/proc/"' in line
        )
        if is_expected:
            expected_total += 1
            if len(expected_proc_mkdir) < 16:
                expected_proc_mkdir.append(sanitized_line)
        else:
            unexpected_total += 1
            if len(unexpected) < 16:
                unexpected.append(sanitized_line)
    return {
        "journal_argv": argv,
        ...
        "storage_overflow": matching_total > len(sanitized),
        "expected_proc_mkdir_total": expected_total,
        "unexpected_total": unexpected_total,
        "sanitized_denials": sanitized,
        "expected_proc_mkdir_denials": expected_proc_mkdir,
...
def classify_execution(result: Mapping[str, Any], audit: Mapping[str, Any]) -> tuple[str, dict[str, Any]]:
    ...
    returncode = result["returncode"]
    if result["failure"] is None and type(returncode) is int and returncode == 0 and not stderr:
        parsed = parse_success_frame(stdout)
        evidence["success_frame"] = parsed
        return "PASS_HARMLESS_PROBE_CLEANUP_PENDING", evidence
    audit_count_keys = ("matching_total", "stored_count", "expected_proc_mkdir_total", "unexpected_total")
    exact_expected_denial = (
        all(type(audit.get(key)) is int for key in audit_count_keys)
        and audit.get("matching_total") == 1
        and audit.get("stored_count") == 1
        and audit.get("storage_overflow") is False
        and audit.get("expected_proc_mkdir_total") == 1
        and audit.get("unexpected_total") == 0
        and len(audit.get("expected_proc_mkdir_denials", [])) == 1
    )
    gate_no_go_envelope = (
        b'"status": "NO_GO"' in stderr
        or b"R8_STDIO_PROBE_V7_NO_GO" in stderr
    )
    if (result["failure"] is None and type(returncode) is int and returncode != 0 and not stdout
            and not gate_no_go_envelope and exact_expected_denial):
        return "PASS_FAIL_CLOSED_APPARMOR_DENIAL_DISCOVERY_CLEANUP_PENDING", evidence
...
def validate_sudo_cleanup_evidence(sudo_clear: Mapping[str, Any]) -> None:
    expected_keys = {
        "scope", "pty", "membership", "identity_contract", "clear",
...
def execution_receipt_document(
    *,
    ...
    return {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V7_EXECUTION_RECEIPT",
        "probe_id": PROBE_ID,
        "status": status,
...
def lifecycle_document(
    *,
    ...
    if stable != [[], [], []] or post_unload_stable != [[], [], []]:
    ...
    return {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V7_LIFECYCLE_RECEIPT",
        "probe_id": PROBE_ID,
        "status": "PASS_V7_PROFILE_PROCESS_SYSCTL_SUDO_LIFECYCLE_CLEANUP",
...
def run_once(*, policy_sha256: str, admission_token: str) -> dict[str, Any]:
    with TerminationGuard() as termination_guard:
        try:
            ...
            document = {
                "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V7_PREFLIGHT_FAILURE_RECEIPT",
                "probe_id": PROBE_ID,
                "status": (
...
def _run_once_guarded(
    *,
    ...
    start_document = {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V7_START_RECEIPT",
        "probe_id": PROBE_ID,
    ...
    try:
        ...
        ended = time.time()
        time.sleep(0.2)
        audit = capture_apparmor_denials(started, ended)
        termination_guard.checkpoint()
    ...
    failure = {
        "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V7_LIFECYCLE_INCOMPLETE_RECEIPT",
        "probe_id": PROBE_ID,
    ...
    raise SupervisorError(f"v7 lifecycle incomplete; preserved receipt {failure_record['path']}")
...
def recover_only(*, policy_sha256: str, recovery_token: str) -> dict[str, Any]:
    ...
    with TerminationGuard() as termination_guard:
        ...
        document = {
            "document_type": "SMPCC_R8_LIQUID_U3_STDIO_APPARMOR_PROBE_V7_RECOVERY_RECEIPT",
            "probe_id": PROBE_ID,
            "status": "PASS_V7_CLEANUP_ONLY_NO_PROBE_EXECUTED",
            "policy_sha256": policy_sha256,
            "snapshot": snapshot,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if arguments.command == "recover-only":
            ...
            print(json.dumps({"status": "V7_CLEANUP_ONLY_RECORDED", "result": result}, ensure_ascii=False, sort_keys=True))
            return 0
        ...
        return 0 if result["execution_status"] in {"PASS_HARMLESS_PROBE_CLEANUP_PENDING", "PASS_FAIL_CLOSED_APPARMOR_DENIAL_DISCOVERY_CLEANUP_PENDING"} else 2

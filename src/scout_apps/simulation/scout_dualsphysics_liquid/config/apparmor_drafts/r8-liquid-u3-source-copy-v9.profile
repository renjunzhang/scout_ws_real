# R8 liquid U3 source-copy profile v9.
# REVIEWED_SINGLE_ATTEMPT_ONLY: v8 source-copy completed, but its independent
# CPU-build phase stopped on the exact AppArmor denial recorded in
# u3_source_cpu_build_20260806T180034Z_cpu_build.json.  v9 uses a distinct,
# create-new output path; this source-copy profile otherwise retains the v8
# source-only surface.  It does not grant standard-header access because cp
# does not need it and compiler execution is forbidden in this phase.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-source-copy-v9 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T181323Z.partial/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T181323Z.partial/output/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T181323Z.partial/output/** rw,
  ...
  mount options=(rw, rbind) /oldroot/home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T181323Z.partial/output/ -> /newroot/work/output/,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v9,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v9,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

# R8 liquid U3 CPU-build profile v15.
...
profile r8-liquid-u3-cpu-build-v15 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-cpu-build-v15,
  signal (send, receive) peer=r8-liquid-u3-cpu-build-v15,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

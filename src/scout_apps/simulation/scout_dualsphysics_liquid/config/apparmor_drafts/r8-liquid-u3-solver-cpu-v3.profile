# R8 liquid U3 C1M CPU-solver smoke v3, fresh one-attempt profile.
#
...
profile r8-liquid-u3-c1m-solver-cpu-bootstrap-v3-20260808t160108z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-c1m-solver-cpu-bootstrap-v3-20260808t160108z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-c1m-solver-cpu-bootstrap-v3-20260808t160108z,
...
profile r8-liquid-u3-c1m-solver-cpu-runtime-v3-20260808t160108z flags=(attach_disconnected,mediate_deleted) {

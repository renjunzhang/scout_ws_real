# R8 liquid U3 harmless AppArmor numeric-proc-stat boundary probe v2.
# Identity: u3_proc_stat_apparmor_boundary_probe_v2_20260809T014926Z.
#
...
profile r8-liquid-u3-proc-stat-boundary-bootstrap-v2-20260809t014926z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v2-20260809t014926z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v2-20260809t014926z,
...
profile r8-liquid-u3-proc-stat-boundary-runtime-v2-20260809t014926z flags=(attach_disconnected,mediate_deleted) {

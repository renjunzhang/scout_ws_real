# R8 liquid U3 C1M zero-motion GenCase v7, fresh transient profile.
#
...
# probe produces one logged denial.  v7 changes only the framed case semantics
# from fixed C1 to moving-boundary/mvnull C1M; direct Python remains the
# v11-proven path and /proc/stat is explicitly quiet-denied.
profile r8-liquid-u3-c1m-gencase-bootstrap-v7-20260808t151500z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-c1m-gencase-bootstrap-v7-20260808t151500z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-c1m-gencase-bootstrap-v7-20260808t151500z,
...
profile r8-liquid-u3-c1m-gencase-runtime-v7-20260808t151500z flags=(attach_disconnected,mediate_deleted) {

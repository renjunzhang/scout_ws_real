# R8 liquid U3 harmless AppArmor numeric-proc-stat boundary probe v4.
# Identity: u3_proc_stat_apparmor_boundary_probe_v4_20260809T031752Z.
#
...
profile r8-liquid-u3-proc-stat-boundary-bootstrap-v4-20260809t031752z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v4-20260809t031752z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v4-20260809t031752z,
...
profile r8-liquid-u3-proc-stat-boundary-runtime-v4-20260809t031752z flags=(attach_disconnected,mediate_deleted) {

# R8 liquid U3 C1M zero-motion GenCase v8, fresh transient profile.
#
...
# probe produces one logged denial.  v8 changes only the framed case semantics
...
profile r8-liquid-u3-c1m-gencase-bootstrap-v8-20260808t153753z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-c1m-gencase-bootstrap-v8-20260808t153753z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-c1m-gencase-bootstrap-v8-20260808t153753z,
...
profile r8-liquid-u3-c1m-gencase-runtime-v8-20260808t153753z flags=(attach_disconnected,mediate_deleted) {

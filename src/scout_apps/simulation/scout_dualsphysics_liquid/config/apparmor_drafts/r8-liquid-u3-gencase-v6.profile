# R8 liquid U3 C1 GenCase v6, fresh single-attempt transient profile.
#
...
# probe produces one logged denial.  v6 keeps both reads unavailable: direct
# Python remains the v11-proven path and /proc/stat is explicitly quiet-denied.
profile r8-liquid-u3-gencase-bootstrap-v6-20260808t072315z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-gencase-bootstrap-v6-20260808t072315z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-gencase-bootstrap-v6-20260808t072315z,
...
profile r8-liquid-u3-gencase-runtime-v6-20260808t072315z flags=(attach_disconnected,mediate_deleted) {

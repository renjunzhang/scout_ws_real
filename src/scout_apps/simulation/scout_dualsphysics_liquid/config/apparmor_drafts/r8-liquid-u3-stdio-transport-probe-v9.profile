# R8 liquid U3 harmless stdio/AppArmor mount-denial discovery probe v9.
#
...
# output/CPU profiles.  The sole permission delta from frozen v8 is exact
# bootstrap path creation authority for /newroot/proc/.  No proc mount rule,
# descendant path permission, or generic mount authority is granted: fixed
# argv deliberately reaches the next fail-closed mount-denial boundary.
profile r8-liquid-u3-stdio-transport-bootstrap-v9-20260808t034143z flags=(attach_disconnected,mediate_deleted) {
  userns create,

  /usr/bin/bwrap rix,
  /usr/bin/python3.12 rix,
  /usr/bin/sleep rpx -> r8-liquid-u3-stdio-transport-runtime-v9-20260808t034143z,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-stdio-transport-bootstrap-v9-20260808t034143z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-bootstrap-v9-20260808t034143z,
  signal (receive) set=(term,kill,exists) peer=unconfined,
  signal (send) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-runtime-v9-20260808t034143z,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

  # Intentionally absent: /newroot/proc/**, every proc mount rule, /dev, host
...
profile r8-liquid-u3-stdio-transport-runtime-v9-20260808t034143z flags=(attach_disconnected,mediate_deleted) {
  /usr/bin/sleep rm,
  /usr/lib/** mr,
  /usr/lib64/** mr,
  /lib/** mr,
  ...
  signal (receive) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-bootstrap-v9-20260808t034143z,
  signal (receive) set=(term,kill,exists) peer=unconfined,

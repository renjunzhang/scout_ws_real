# R8 liquid U3 source-copy profile v10.
# REVIEWED_SINGLE_ATTEMPT_ONLY: v9 source-copy passed and its build reached
# source-level GCC 13 compatibility errors, not an AppArmor denial.  v10 uses
# a distinct create-new output path; this profile retains the v9 source-only
# surface and intentionally contains no compiler-header or source-patch rule.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-source-copy-v10 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v10,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v10,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

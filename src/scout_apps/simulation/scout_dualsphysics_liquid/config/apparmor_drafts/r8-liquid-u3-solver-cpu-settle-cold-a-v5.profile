# R8 liquid U3 C1M CPU-solver settle cold A v5, fresh one-attempt profile.
# Campaign: u3_c1m_solver_cpu_settle_ab_campaign_20260808T203712Z
# Case: u3_c1m_solver_cpu_settle_cold_a_v5_20260808T203712Z (campaign role cold_a).
#
...
profile r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v5-20260808t203712z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v5-20260808t203712z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v5-20260808t203712z,
...
profile r8-liquid-u3-c1m-solver-cpu-settle-cold-a-runtime-v5-20260808t203712z flags=(attach_disconnected,mediate_deleted) {

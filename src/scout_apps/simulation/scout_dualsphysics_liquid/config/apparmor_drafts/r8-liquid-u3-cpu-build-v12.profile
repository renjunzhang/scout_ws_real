# R8 liquid U3 CPU-build profile v12.
...
# identity and corrects that wrapper-state bug only; the reviewed guest
# /lib -> usr/lib link is retained without any host /lib bind or added runtime
# execution permission.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-cpu-build-v12 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-cpu-build-v12,
  signal (send, receive) peer=r8-liquid-u3-cpu-build-v12,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

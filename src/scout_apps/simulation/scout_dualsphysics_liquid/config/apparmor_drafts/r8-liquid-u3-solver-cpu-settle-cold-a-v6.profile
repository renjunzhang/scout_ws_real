# R8 liquid U3 C1M CPU-solver settle cold A v6, fresh one-attempt profile.
# Campaign: u3_c1m_solver_cpu_settle_ab_campaign_20260808T212044Z
# Case: u3_c1m_solver_cpu_settle_cold_a_v6_20260808T212044Z (campaign role cold_a).
#
...
profile r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v6-20260808t212044z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  # Exact directory read needed only for os.scandir('/proc'); child entries
  # remain constrained by the pre-existing owner /proc/** read rule.
  /proc/ r,
  owner /proc/** r,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v6-20260808t212044z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v6-20260808t212044z,
...
profile r8-liquid-u3-c1m-solver-cpu-settle-cold-a-runtime-v6-20260808t212044z flags=(attach_disconnected,mediate_deleted) {

# R8 liquid U3 harmless AppArmor numeric-proc-stat boundary probe v5.
# Identity: u3_proc_stat_apparmor_boundary_probe_v5_20260809T042751Z.
#
...
# bounded, expected DENIED record.  Userspace stat ownership is expected to be
# the host-observed inner projection 0:0; only the exact outer audit record
# (fsuid=1000, ouid=0) proves the access is non-owner.  Frozen v6 already proved
# that pinned system Python starts while the linker cache is quietly denied.
profile r8-liquid-u3-proc-stat-boundary-bootstrap-v5-20260809t042751z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v5-20260809t042751z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v5-20260809t042751z,
...
profile r8-liquid-u3-proc-stat-boundary-runtime-v5-20260809t042751z flags=(attach_disconnected,mediate_deleted) {

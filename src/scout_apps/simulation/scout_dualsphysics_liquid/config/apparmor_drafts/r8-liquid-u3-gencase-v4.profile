# R8 liquid U3 C1 GenCase v4, fresh single-attempt transient profile.
#
...
# v4 removes that process entirely instead of granting a new proc read rule;
# the direct Python launch is the exact already-proven v11 identity path.
profile r8-liquid-u3-gencase-bootstrap-v4-20260808t065518z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-gencase-bootstrap-v4-20260808t065518z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-gencase-bootstrap-v4-20260808t065518z,
...
profile r8-liquid-u3-gencase-runtime-v4-20260808t065518z flags=(attach_disconnected,mediate_deleted) {

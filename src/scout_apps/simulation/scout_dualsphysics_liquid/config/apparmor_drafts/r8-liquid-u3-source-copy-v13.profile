# R8 liquid U3 source-copy profile v13.
...
profile r8-liquid-u3-source-copy-v13 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v13,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v13,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

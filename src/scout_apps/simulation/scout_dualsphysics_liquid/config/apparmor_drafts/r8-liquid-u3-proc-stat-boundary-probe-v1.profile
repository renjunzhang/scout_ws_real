# R8 liquid U3 harmless AppArmor numeric-proc-stat boundary probe v1.
# Identity: u3_proc_stat_apparmor_boundary_probe_v1_20260809T002729Z.
#
...
# same lifecycle.
#
# The proc authority baseline is frozen cold-A v6 failure provenance. Relative
# to that baseline, the sole new non-owner authority is the numeric-PID stat
# read below. Status remains deliberately absent so one dumpable-zero child
# produces one bounded, expected DENIED record.
profile r8-liquid-u3-proc-stat-boundary-bootstrap-v1-20260809t002729z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v1-20260809t002729z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-proc-stat-boundary-bootstrap-v1-20260809t002729z,
...
profile r8-liquid-u3-proc-stat-boundary-runtime-v1-20260809t002729z flags=(attach_disconnected,mediate_deleted) {

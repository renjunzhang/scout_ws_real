# R8 liquid U3 harmless stdio/AppArmor denial-discovery probe v6 successor.
#
...
profile r8-liquid-u3-stdio-transport-bootstrap-v6-20260807t173214z flags=(attach_disconnected,mediate_deleted) {
  userns create,

  /usr/bin/bwrap rix,
  /usr/bin/python3.12 rix,
  /usr/bin/sleep rpx -> r8-liquid-u3-stdio-transport-runtime-v6-20260807t173214z,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-stdio-transport-bootstrap-v6-20260807t173214z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-bootstrap-v6-20260807t173214z,
  signal (receive) set=(term,kill,exists) peer=unconfined,
  signal (send) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-runtime-v6-20260807t173214z,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,
...
profile r8-liquid-u3-stdio-transport-runtime-v6-20260807t173214z flags=(attach_disconnected,mediate_deleted) {
  /usr/bin/sleep rm,
  /usr/lib/** mr,
  /usr/lib64/** mr,
  /lib/** mr,
  ...
  signal (receive) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-bootstrap-v6-20260807t173214z,
  signal (receive) set=(term,kill,exists) peer=unconfined,

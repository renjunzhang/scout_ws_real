# R8 liquid U3 C1 CPU-solver smoke v2, fresh one-attempt profile.
#
...
profile r8-liquid-u3-solver-cpu-bootstrap-v2-20260808t134452z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-solver-cpu-bootstrap-v2-20260808t134452z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-solver-cpu-bootstrap-v2-20260808t134452z,
...
profile r8-liquid-u3-solver-cpu-runtime-v2-20260808t134452z flags=(attach_disconnected,mediate_deleted) {

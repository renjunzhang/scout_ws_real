# R8 liquid U3 source-copy profile v11.
# REVIEWED_SINGLE_ATTEMPT_ONLY: v10 source-copy passed and its restricted build
# compiled all source translation units, then the linker could not resolve the
# absolute /lib paths named by the read-only host /usr linker scripts.  v11
# creates a distinct output path and permits only creation of the synthetic
# guest /lib -> usr/lib symlink; it does not add a host /lib bind or any new
# source/compiler/runtime surface.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-source-copy-v11 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T184504Z.partial/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T184504Z.partial/output/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T184504Z.partial/output/** rw,
  ...
  mount options=(rw, rbind) /oldroot/home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T184504Z.partial/output/ -> /newroot/work/output/,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v11,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v11,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

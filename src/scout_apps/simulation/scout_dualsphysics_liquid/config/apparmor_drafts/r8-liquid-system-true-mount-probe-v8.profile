# R8 liquid target transient AppArmor mount-confinement probe v8.
...
# rprivate propagation setting on temporary /oldroot/, and its exact unmount.
# Bubblewrap 0.9.0 documents that it always creates a new mount namespace.
# This profile never permits a host bind, generic umount, remount, procfs,
...
profile r8-liquid-system-true-mount-probe-v8 flags=(attach_disconnected,mediate_deleted) {
  ...
  ptrace (read, readby) peer=r8-liquid-system-true-mount-probe-v8,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

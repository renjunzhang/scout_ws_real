# R8 liquid U3 C1M CPU-solver settle cold A v4, fresh one-attempt profile.
#
...
profile r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v4-20260808t174116z flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v4-20260808t174116z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-c1m-solver-cpu-settle-cold-a-bootstrap-v4-20260808t174116z,
...
profile r8-liquid-u3-c1m-solver-cpu-settle-cold-a-runtime-v4-20260808t174116z flags=(attach_disconnected,mediate_deleted) {

# R8 liquid U3 harmless stdio/AppArmor exact proc-mount success probe v10.
#
...
# output/CPU profiles.  Frozen v9 proved one unique proc mount denial with
# exactly rw,nosuid,nodev,noexec flags.  The sole v10 authority delta is the
# matching source/fstype/options/target mount rule below.  No descendant path
# permission or generic mount authority is granted.
profile r8-liquid-u3-stdio-transport-bootstrap-v10-20260808t045130z flags=(attach_disconnected,mediate_deleted) {
  userns create,

  /usr/bin/bwrap rix,
  /usr/bin/python3.12 rix,
  /usr/bin/sleep rpx -> r8-liquid-u3-stdio-transport-runtime-v10-20260808t045130z,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-stdio-transport-bootstrap-v10-20260808t045130z,
  signal (send,receive) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-bootstrap-v10-20260808t045130z,
  signal (receive) set=(term,kill,exists) peer=unconfined,
  signal (send) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-runtime-v10-20260808t045130z,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,
...
profile r8-liquid-u3-stdio-transport-runtime-v10-20260808t045130z flags=(attach_disconnected,mediate_deleted) {
  /usr/bin/sleep rm,
  /usr/lib/** mr,
  /usr/lib64/** mr,
  /lib/** mr,
  ...
  signal (receive) set=(term,kill,exists) peer=r8-liquid-u3-stdio-transport-bootstrap-v10-20260808t045130z,
  signal (receive) set=(term,kill,exists) peer=unconfined,

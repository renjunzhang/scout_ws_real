# R8 liquid U3 source-copy profile v2.
# REVIEWED_SINGLE_ATTEMPT_ONLY: a new revision after v1 stopped before bwrap
# because an ordinary user cannot clear its own supplementary groups.  The
# only revised outer action is sudo -> setpriv, which drops to zrj:zrj with no
# supplementary groups *before* aa-exec.  This named profile remains transient
# and must never be installed under /etc/apparmor.d.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-source-copy-v2 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T171401Z.partial/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T171401Z.partial/output/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T171401Z.partial/output/** rw,
  ...
  mount options=(rw, rbind) /oldroot/home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T171401Z.partial/output/ -> /newroot/work/output/,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v2,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v2,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

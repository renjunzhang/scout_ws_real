# R8 liquid U3 source-copy profile v15.
# REVIEWED_SINGLE_ATTEMPT_ONLY: v14 source-copy and CPU build completed; the
# linked, non-executable candidate reached output inventory, which incorrectly
# rejected ordinary directory link counts. v15 has a new output identity and no
# broader mount, executable, compiler, source, device or transition
# permission.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-source-copy-v15 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260807T023724Z.partial/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260807T023724Z.partial/output/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260807T023724Z.partial/output/** rw,
  ...
  mount options=(rw, rbind) /oldroot/home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260807T023724Z.partial/output/ -> /newroot/work/output/,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v15,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v15,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

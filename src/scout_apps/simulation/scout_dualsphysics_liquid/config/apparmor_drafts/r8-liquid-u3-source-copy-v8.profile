# R8 liquid U3 source-copy profile v8.
# REVIEWED_SINGLE_ATTEMPT_ONLY: v7 reached bubblewrap 0.9.0's exact
# O_WRONLY open of /proc/sys/user/max_user_namespaces but the Linux per-userns
# sysctl handler requires CAP_SYS_RESOURCE in the first bwrap user namespace.
# This revision adds only that capability and retains the one exact sysctl
# write.  Linux stores this limit in the first user namespace's ucount table;
# the gate rejects the attempt if the host-initial-namespace value differs
# before and after the child.  No other capability or /proc/sys write changes.
abi <abi/4.0>,

include <tunables/global>

profile r8-liquid-u3-source-copy-v8 flags=(attach_disconnected,mediate_deleted) {
  userns create,
  ...
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T180034Z.partial/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T180034Z.partial/output/ rw,
  /home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T180034Z.partial/output/** rw,
  ...
  mount options=(rw, rbind) /oldroot/home/zrj/scout_liquid_lab/build/u3_source_cpu_build_20260806T180034Z.partial/output/ -> /newroot/work/output/,
  ...
  ptrace (read, readby) peer=r8-liquid-u3-source-copy-v8,
  signal (send, receive) peer=r8-liquid-u3-source-copy-v8,
  network unix dgram,
  network inet dgram,
  network inet6 dgram,
  network netlink raw,

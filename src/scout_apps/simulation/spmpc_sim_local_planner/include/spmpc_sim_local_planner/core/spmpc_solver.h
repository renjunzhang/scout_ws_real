...
#include "spmpc_sim_local_planner/core/start_lock_recovery.h"  // SolverParams.start_lock_recovery 需要完整参数
#include "spmpc_sim_local_planner/core/terminal_controller.h"  // SolverParams.terminal 需要完整 TerminalControllerParams

...
runtime_paths=(
  ...
  src/scout_apps/control/spmpc_local_planner/scripts/real/record_spmpc_experiment.sh
...
relevant_repo_paths=(
  "${runtime_paths[@]}"
  src/scout_apps/control/spmpc_local_planner/scripts/protocols/g_series/run_spmpc_g3_processed_imu_w5_vs_bsmooth_trial.sh

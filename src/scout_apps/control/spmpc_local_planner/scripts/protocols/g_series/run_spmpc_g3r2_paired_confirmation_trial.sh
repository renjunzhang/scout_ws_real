...
TIMESTAMP_GATE="${SCRIPT_DIR}/rgb/validate_realsense_timestamp_health.py"
...
relevant_repo_paths=(
  ...
  src/scout_apps/control/spmpc_local_planner/scripts/protocols/g_series/run_spmpc_g3r2_paired_confirmation_trial.sh
  src/scout_apps/control/spmpc_local_planner/scripts/rgb/validate_realsense_timestamp_health.py

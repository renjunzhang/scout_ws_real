...
FIXED_RUNNER="${SCRIPT_DIR}/real/run_fixed_profile_real_trial.sh"
VALIDATOR="${SCRIPT_DIR}/analysis/validate_g5_minimal_trial.py"
ANALYZER="${SCRIPT_DIR}/analysis/analyze_g5_minimal.py"

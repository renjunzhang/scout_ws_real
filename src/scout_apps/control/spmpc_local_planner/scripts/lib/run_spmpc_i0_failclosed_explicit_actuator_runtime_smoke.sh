...
RECORDER="${SCRIPT_DIR}/real/record_spmpc_full_rgb_bag.sh"
...
FULL_DA_WRAPPER="${SCRIPT_DIR}/protocols/comparisons/run_spmpc_full_da_smoke.sh"
...
if [[ "${SMOKE_PROFILE}" == ablation ]]; then
  required_files+=("${ABLATION_POSTFLIGHT}" "${SCRIPT_DIR}/lib/spmpc_ablation_profile.sh"
    ...
    "${SCRIPT_DIR}/real/run_spmpc_ablation_smoke.sh" "${SCRIPT_DIR}/tests/test_spmpc_ablation_smoke.py")
fi
...
runtime_paths=(
  ...
  src/scout_apps/control/spmpc_local_planner/scripts/real/run_spmpc_ablation_smoke.sh
  ...
  src/scout_apps/control/spmpc_local_planner/scripts/protocols/comparisons/run_spmpc_weight_smoke.sh
  src/scout_apps/control/spmpc_local_planner/scripts/protocols/comparisons/run_spmpc_full_da_smoke.sh
  src/scout_apps/control/spmpc_local_planner/scripts/lib/run_spmpc_i0_failclosed_explicit_actuator_runtime_smoke.sh

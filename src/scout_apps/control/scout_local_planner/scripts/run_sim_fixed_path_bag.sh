...
case "${CONDITION}" in
    ...
    *)
        ...
        echo "Use NOM, PROFILE_ENERGY_GEO, PROFILE_REF_V2, FAS_Q5, FAS_Q5_DOT, FAS_Q10, FAS_Q5_TERM, PROP_Q5, ISR, CUSTOM, RAW_TUNED, GEOREF_TUNED, GEOREF_OSCRS_SHADOW, GEOREF_OSCRS_ACTIVE, GEOREF_SLOSH_SCORE, GEOREF_SLOSH_SCORE_TUNED, or GEOREF_ORIGINAL." >&2
        exit 2
        ;;
esac
